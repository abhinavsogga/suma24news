        ...
        <div class="row">
          ...
          <div class="col-sm-9 text-left text-md-end">
            <ul class="list-unstyled d-inline-flex social_icons">
              <li><a href="https://facebook.com/" target="_blank" rel="nofollow">
              ...
              <li><a href="https://youtube.com" target="_blank" rel="nofollow">
              ...
              <li><a href="#" target="_blank" rel="nofollow">
                  <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M19 8C15.6863 8 13 5.31371 13 2" stroke="#fff" stroke-width="1.5" stroke-linecap="round" />
                  </svg>
                </a></li>
              <li><a href="https://pintrest.com/" target="_blank" rel="nofollow">
                  <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
